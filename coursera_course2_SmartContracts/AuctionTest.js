          ...
          ***********/
          ...
          .then(function(result) {
            ...
            ***********/
             ...
             ***********/
               return auctionInstance.getWinner(0, {from:accounts[0]})
           }).then(function(result) {
             /**********
             ...
             ***********/
             /*<CODE HERE>*/
             assert.notEqual(result, "0x0000000000000000000000000000000000000000","not a valid winner");
             /**********
             TASK 16: call winners function from accounts[0] to get the winner of item id 1
             ***********/
             return auctionInstance.getWinner(1, {from:accounts[0]})
           }).then(function(result) {
             /**********
             ...
             ***********/
             return auctionInstance.getWinner(2, {from:accounts[0]})
           }).then(function(result) {
             /**********
             /**********
